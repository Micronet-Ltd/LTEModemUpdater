    ...
    private void checkIfUpdatesAreAvailable(String modemType, String modemFirmwareVersion) {
        switch (modemType) {
            ...
            case "LE910-NA1":
                switch (modemFirmwareVersion) {
                    case "20.00.525.2":
                        String info = "Device has 20.00.525.2. Already updated.";
                        context.updateTvInfo(info);
                        context.updateBackgroundColor(Color.GREEN);
                        context.updateTvWarning("Already Updated");
                        startRild();
    ...
    private boolean readInUpdateFile() {
        ...
        switch (updateFileType) {
            ...
            case V20_00_034_10:
                ...
                break;
            case V20_00_522_4:
                updateInputStream = context.getResources().openRawResource(R.raw.update_522_4_to_525_2);
                break;
            case V20_00_522_7:
    ...
    private Runnable updateRunnable = new Runnable() {
        ...
        public void run() {
            ...
            if (updated) {
                ...
                context.updateBackgroundColor(Color.GREEN);
                context.updateTvInfo("Successfully updated modem firmware!");
                context.updateTvWarning("Update Successful");
